...
Version: ${_VERSION}
Architecture: ${_ARCH}
Maintainer: @gamenoshame
Depends: ${_depend}
Homepage: https://github.com/NavinSha1801/NavinFisher.git
...
cp -fr .github/ .sites/ LICENSE README.md NFisher.sh ./build_env/$_opt_dir
